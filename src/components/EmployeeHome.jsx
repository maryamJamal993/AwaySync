...
const EmployeeHome = () => {
  ...
  const leaveData = [
    ...
    { id: 'AL012345', status: 'Pending', leaveType: 'Annula Leave', startDate: '2024-06-03', endDate: '2024-06-05', reason: 'Flu', files: 'None' },
  ];
      ...
      <div className="upper-part">
        ...
        <div className="lower-part">
          ...
          <div className="buttons-section">
            <button className="leave-policies-button">Read Leave Policies</button>
            <button className="new-leave-request-button">New Leave Request</button>
          </div>
        </div>
      </div>
    </div>
